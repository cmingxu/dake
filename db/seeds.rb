...
tongliao = User.create! :name => "通辽管理员", :login => "tongliao_admin", :password => "adminadmin", :password_confirmation => "adminadmin", :email => "hushia_dmin@admin.com", :roles => ["agent"], :mobile => "13812345678"
...
def rand_balance
   ...
   l = u.locations.first
   r = u.locations.first.routes.sample
   return unless r
