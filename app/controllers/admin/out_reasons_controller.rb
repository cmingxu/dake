# -*- encoding : utf-8 -*-
class Admin::OutReasonsController < Admin::BaseController
  # GET /reasons
  # GET /reasons.json
  def index
  ...
  def create
    ...
    respond_to do |format|
      if @reason.save
        format.html { redirect_to admin_out_reasons_path, notice: 'Reason was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @reason.update_attributes(params[:reason])
        format.html { redirect_to admin_out_reasons_path, notice: 'Reason was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_out_reasons_path }
      format.json { head :no_content }
    end
  end
end
